  ...
  <div id="Home">
    <section class="card">
      ...
      <ul>
        ...
        <li class="lh2">I'm excited to program every day, and am self-teaching Vue, Python, Postgres, and Firebase.</li>
...
<style scoped>
  ...
  .lh2 { line-height: 1.75; }
  .spacer { border-right: 2px white solid; }
  a {
    color: white;
    font-size: 12rem;
